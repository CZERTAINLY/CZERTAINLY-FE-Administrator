...
export type ConnectorRequestModel = Omit<ConnectorRequestDto, "authAttributes"> & { authAttributes?: Array<AttributeRequestModel> }

export type ConnectorUpdateRequestDto = ConnectorUpdateRequestDtoOpenApi;
export type ConnectorUpdateRequestModel = Omit<ConnectorUpdateRequestDto, "authAttributes"> & { authAttributes?: Array<AttributeRequestModel> };

export type ConnectorResponseDto = ConnectorDto;
export type ConnectorResponseModel = Omit<ConnectorResponseDto, "functionGroups | authAttributes"> & { functionGroups: Array<FunctionGroupModel>, authAttributes?: Array<AttributeResponseModel> }
