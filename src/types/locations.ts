...
export type LocationAddRequestModel = Omit<LocationAddRequestDto, "attributes | customAttributes"> & { attributes: Array<AttributeRequestModel>, customAttributes?: Array<AttributeRequestModel> }

export type LocationEditRequestDto = EditLocationRequestDto;
export type LocationEditRequestModel = Omit<LocationEditRequestDto, "attributes | customAttributes"> & { attributes: Array<AttributeRequestModel>, customAttributes?: Array<AttributeRequestModel> }
...
export type LocationResponseModel = Omit<LocationResponseDto, "attributes | certificates | metadata | customAttributes"> & { attributes: Array<AttributeResponseModel>, certificates: Array<LocationCertificateModel>, metadata?: Array<MetadataModel>, customAttributes?: Array<AttributeResponseModel> };
