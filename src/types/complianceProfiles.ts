...
export type ComplianceProfileResponseRuleRuleModel = Omit<ComplianceProfileResponseRuleRuleDto, "attributes"> & { attributes?: Array<AttributeResponseModel> };

export type ComplianceProfileResponseRuleDto = ComplianceConnectorAndRulesDto;
export type ComplianceProfileResponseRuleModel = Omit<ComplianceProfileResponseRuleDto, "rules"> & { rules?: Array<ComplianceProfileResponseRuleRuleModel> };
//-
...
export type ComplianceProfileRequestRuleRuleModel = Omit<ComplianceProfileRequestRuleRuleDto, "attributes"> & { attributes?: Array<AttributeRequestModel> };
...
export type ComplianceProfileRuleAddRequestModel = Omit<ComplianceProfileRuleAddRequestDto, "attributes"> & { attributes?: Array<AttributeRequestModel> };

export type ComplianceProfileRuleAddResponseDto = ComplianceProfileRuleDto;
export type ComplianceProfileRuleAddResponseModel = Omit<ComplianceProfileRuleAddResponseDto, "attributes"> & { attributes: Array<AttributeResponseModel> };
//---
...
export type ComplianceProfileGroupListResponseModel = Omit<ComplianceProfileGroupListResponseDto, "groups"> & { groups: Array<ComplianceProfileGroupListResponseGroupModel> };
