...
export class ConnectorAuthenticationApi extends BaseAPI {
     ...
     */
    getApiKeyAuthAttributes(): Observable<Array<DataAttributeDto>>
    getApiKeyAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<DataAttributeDto>>>
    getApiKeyAuthAttributes(opts?: OperationOpts): Observable<Array<DataAttributeDto> | AjaxResponse<Array<DataAttributeDto>>> {
        return this.request<Array<DataAttributeDto>>({
     ...
     */
    getBasicAuthAttributes(): Observable<Array<DataAttributeDto>>
    getBasicAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<DataAttributeDto>>>
    getBasicAuthAttributes(opts?: OperationOpts): Observable<Array<DataAttributeDto> | AjaxResponse<Array<DataAttributeDto>>> {
        return this.request<Array<DataAttributeDto>>({
     ...
     */
    getCertificateAttributes(): Observable<Array<DataAttributeDto>>
    getCertificateAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<DataAttributeDto>>>
    getCertificateAttributes(opts?: OperationOpts): Observable<Array<DataAttributeDto> | AjaxResponse<Array<DataAttributeDto>>> {
        return this.request<Array<DataAttributeDto>>({
     ...
     */
    getJWTAuthAttributes(): Observable<Array<DataAttributeDto>>
    getJWTAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<DataAttributeDto>>>
    getJWTAuthAttributes(opts?: OperationOpts): Observable<Array<DataAttributeDto> | AjaxResponse<Array<DataAttributeDto>>> {
        return this.request<Array<DataAttributeDto>>({
