...
export class ExternalNotificationManagementApi extends BaseAPI {
     ...
     */
    listMappingAttributes({ connectorUuid, kind }: ListMappingAttributesRequest): Observable<Array<DataAttributeDto>>
    listMappingAttributes({ connectorUuid, kind }: ListMappingAttributesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<DataAttributeDto>>>
    listMappingAttributes({ connectorUuid, kind }: ListMappingAttributesRequest, opts?: OperationOpts): Observable<Array<DataAttributeDto> | AjaxResponse<Array<DataAttributeDto>>> {
