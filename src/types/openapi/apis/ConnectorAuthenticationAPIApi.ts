 ...
 * no description
 */
export class ConnectorAuthenticationAPIApi extends BaseAPI {

    /**
     * Get API Key auth Attributes
     */
    getApiKeyAuthAttributes(): Observable<Array<ListLocationAttributes200ResponseInner>>
    getApiKeyAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    getApiKeyAuthAttributes(opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
     ...
     */
    getBasicAuthAttributes(): Observable<Array<ListLocationAttributes200ResponseInner>>
    getBasicAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    getBasicAuthAttributes(opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
        return this.request<Array<ListLocationAttributes200ResponseInner>>({
     ...
     */
    getCertificateAttributes(): Observable<Array<ListLocationAttributes200ResponseInner>>
    getCertificateAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    getCertificateAttributes(opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
        return this.request<Array<ListLocationAttributes200ResponseInner>>({
     ...
     */
    getJWTAuthAttributes(): Observable<Array<ListLocationAttributes200ResponseInner>>
    getJWTAuthAttributes(opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    getJWTAuthAttributes(opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
        return this.request<Array<ListLocationAttributes200ResponseInner>>({
