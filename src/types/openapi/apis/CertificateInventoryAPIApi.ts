 ...
 * no description
 */
export class CertificateInventoryAPIApi extends BaseAPI {
     ...
     */
    listLocations({ certificateUuid }: ListLocationsRequest): Observable<Array<LocationDto>>
    listLocations({ certificateUuid }: ListLocationsRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<LocationDto>>>
    listLocations({ certificateUuid }: ListLocationsRequest, opts?: OperationOpts): Observable<Array<LocationDto> | AjaxResponse<Array<LocationDto>>> {
        throwIfNullOrUndefined(certificateUuid, 'certificateUuid', 'listLocations');
