...
export class CustomAttributesApi extends BaseAPI {
     ...
     */
    getResourceCustomAttributes({ resource }: GetResourceCustomAttributesRequest): Observable<Array<CustomAttributeDto>>
    getResourceCustomAttributes({ resource }: GetResourceCustomAttributesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<CustomAttributeDto>>>
    getResourceCustomAttributes({ resource }: GetResourceCustomAttributesRequest, opts?: OperationOpts): Observable<Array<CustomAttributeDto> | AjaxResponse<Array<CustomAttributeDto>>> {
        throwIfNullOrUndefined(resource, 'resource', 'getResourceCustomAttributes');

        return this.request<Array<CustomAttributeDto>>({
     ...
     */
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest): Observable<Array<ResponseAttributeDto>>
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ResponseAttributeDto>>>
    updateAttributeContentForResource({ resourceName, objectUuid, attributeUuid, attributeContent }: UpdateAttributeContentForResourceRequest, opts?: OperationOpts): Observable<Array<ResponseAttributeDto> | AjaxResponse<Array<ResponseAttributeDto>>> {
