 ...
 * no description
 */
export class EntityManagementAPIApi extends BaseAPI {
     ...
     */
    listLocationAttributes({ entityUuid }: ListLocationAttributesRequest): Observable<Array<ListLocationAttributes200ResponseInner>>
    listLocationAttributes({ entityUuid }: ListLocationAttributesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    listLocationAttributes({ entityUuid }: ListLocationAttributesRequest, opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
