...
export interface GetAttributesRequest {
    uuid: string;
    functionGroup: GetAttributesFunctionGroupEnum;
    kind: string;
}
...
export interface ListConnectorsRequest {
    functionGroup?: ListConnectorsFunctionGroupEnum;
    kind?: string;
    status?: ListConnectorsStatusEnum;
}
 ...
 * no description
 */
export class ConnectorManagementAPIApi extends BaseAPI {
     ...
     */
    getAttributes({ uuid, functionGroup, kind }: GetAttributesRequest): Observable<Array<ListLocationAttributes200ResponseInner>>
    getAttributes({ uuid, functionGroup, kind }: GetAttributesRequest, opts?: OperationOpts): Observable<AjaxResponse<Array<ListLocationAttributes200ResponseInner>>>
    getAttributes({ uuid, functionGroup, kind }: GetAttributesRequest, opts?: OperationOpts): Observable<Array<ListLocationAttributes200ResponseInner> | AjaxResponse<Array<ListLocationAttributes200ResponseInner>>> {
     ...
     */
    getAttributesAll({ uuid }: GetAttributesAllRequest): Observable<{ [key: string]: { [key: string]: Array<ListRevokeCertificateAttributes200ResponseInner>; }; }>
    getAttributesAll({ uuid }: GetAttributesAllRequest, opts?: OperationOpts): Observable<AjaxResponse<{ [key: string]: { [key: string]: Array<ListRevokeCertificateAttributes200ResponseInner>; }; }>>
    getAttributesAll({ uuid }: GetAttributesAllRequest, opts?: OperationOpts): Observable<{ [key: string]: { [key: string]: Array<ListRevokeCertificateAttributes200ResponseInner>; }; } | AjaxResponse<{ [key: string]: { [key: string]: Array<ListRevokeCertificateAttributes200ResponseInner>; }; }>> {
        throwIfNullOrUndefined(uuid, 'uuid', 'getAttributesAll');

        return this.request<{ [key: string]: { [key: string]: Array<ListRevokeCertificateAttributes200ResponseInner>; }; }>({
 ...
 * @enum {string}
 */
export enum GetAttributesFunctionGroupEnum {
 ...
 * @enum {string}
 */
export enum ListConnectorsFunctionGroupEnum {
    CredentialProvider = 'credentialProvider',
    LegacyAuthorityProvider = 'legacyAuthorityProvider',
    AuthorityProvider = 'authorityProvider',
    DiscoveryProvider = 'discoveryProvider',
 ...
 * @enum {string}
 */
export enum ListConnectorsStatusEnum {
