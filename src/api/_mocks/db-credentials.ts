   ...
   "ejbca-client-cert": {
      ...
      attributes: [
         ...
         },
         {
            ...
            label: "Name",
            type: "STRING",
            content: { value: "ejbca-client-cert" }
         },
         {
