...
export const slice = createSlice({
   ...
   reducers: {
      ...
      listSignatureAttributeDescriptors: (state, action: PayloadAction<{ tokenInstanceUuid: string, tokenProfileUuid: string, uuid: string, keyItemUuid: string, algorithm: CryptographicAlgorithm }>) => {
      ...
      listSignatureAttributeDescriptorsSuccess: (state, action: PayloadAction<{ uuid: string, attributeDescriptors: AttributeDescriptorModel[] }>) => {
      ...
      listCipherAttributeDescriptors: (state, action: PayloadAction<{ tokenInstanceUuid: string, tokenProfileUuid: string, uuid: string, keyItemUuid: string, algorithm: CryptographicAlgorithm }>) => {
      ...
      listCipherAttributeDescriptorsSuccess: (state, action: PayloadAction<{ uuid: string, attributeDescriptors: AttributeDescriptorModel[] }>) => {
      ...
      listRandomAttributeDescriptorsSuccess: (state, action: PayloadAction<{ uuid: string, attributeDescriptors: AttributeDescriptorModel[] }>) => {
      ...
      signData: (state, action: PayloadAction<{ tokenInstanceUuid: string, tokenProfileUuid: string, uuid: string, keyItemUuid: string, request: CryptographicKeySignDataRequestModel }>) => {
      ...
      verifyData: (state, action: PayloadAction<{ tokenInstanceUuid: string, tokenProfileUuid: string, uuid: string, keyItemUuid: string, request: CryptographicKeyVerifyDataRequestModel }>) => {
      ...
      generateRandomData: (state, action: PayloadAction<{ tokenInstanceUuid: string, request: CryptographicKeyRandomDataRequestModel }>) => {
            state.isGeneratingRandomData = true;
      
      },


      generateRandomDataSuccess: (state, action: PayloadAction<{ uuid: string, randomData: CryptographicKeyRandomDataResponseModel }>) => {
