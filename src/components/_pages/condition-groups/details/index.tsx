        ...
        () =>
            !conditionGroupsDetails
                ...
                : [
                      ...
                      {
                          id: 'resource',
                          columns: ['Resource', conditionGroupsDetails.resource],
                      },
                      {
                          id: 'description',
    ...
    return (
        <Container className="themed-container" fluid>
            <Row xs="1" sm="1" md="2" lg="2" xl="2">
                <Col>
                    <Widget busy={isFetchingConditionGroup} title="Condition Group Details" titleSize="large" widgetButtons={buttons}>
