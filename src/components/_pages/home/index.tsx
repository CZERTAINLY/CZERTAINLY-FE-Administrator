      ...
      <Container className="themed-container" fluid>
         ...
         <Row xs="1" sm="1" md="2" lg="2" xl="2">
            ...
            <Col>
               ...
               <Widget title={<h2><span className="fw-semi-bold">Guides</span></h2>}>
                  ...
                  <p>
                     ...
                     <a href="https://www.czertainly.com" target="_blank" rel="noopener noreferrer">CZERTAINLY Official Documentation</a>
            ...
            <Col>
               ...
               <Widget title={<h2><span className="fw-semi-bold">Feedback</span></h2>} >
                  ...
                  <p>
                     For any kind of feedback, use the <br />
         ...
         <Widget title={<h2><span className="fw-semi-bold">About</span></h2>}>
            ...
            <ul>
               ...
               <li>
                  Developer: <a href="https://www.czertainly.com" target="_blank" rel="noopener noreferrer">CZERTAINLY s.r.o.</a>
               </li>
         ...
         <Widget title={<h2><span className="fw-semi-bold">Support</span></h2>}>
