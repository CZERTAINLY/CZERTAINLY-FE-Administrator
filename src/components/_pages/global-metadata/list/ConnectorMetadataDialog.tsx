    ...
    return <Dialog
        ...
        body={
            <>
                ...
                {connectorMetadataTableData.length > 0 ? <CustomTable
                    headers={connectorMetadataTableHeaders}
                    data={connectorMetadataTableData}
