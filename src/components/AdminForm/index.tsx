   ...
   useEffect(() => {
      ...
      if (params.id && administratorSelector?.uuid === params.id) {
         ...
         if (editMode) {
            ...
            if (!loadedCerts.find(cert => cert.uuid === administratorSelector.certificate.uuid)) {
               setLoadedCerts([...loadedCerts, administratorSelector.certificate]);
            }

            console.log(certSelectRef.current);
