...
const infoAttributeDescriptorProps: AttributeDescriptorViewerProps = {
...
const customAttributeDescriptorProps: AttributeDescriptorViewerProps = {
    attributeDescriptors: [
        {
            uuid: 'test-uuid-1',
            name: 'test-name-1',
...
const dataAttributeDescriptorProps: AttributeDescriptorViewerProps = {
    attributeDescriptors: [
        {
...
const groupAttributeDescriptorProps: AttributeDescriptorViewerProps = {
    attributeDescriptors: [
        {
